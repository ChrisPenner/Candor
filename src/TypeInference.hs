...
-- infer ast =
--   case unfix ast of
--     P prim -> inferPrim prim
--     Builtin name -> inferSymbol name
--     FuncDef args expr -> inferFunc args expr
--     List l -> inferList l
--     Appl f args -> inferAppl f args
-- inferPrim :: Prim -> InferM Monotype
-- inferPrim Str {} = return stringT
-- inferPrim Number {} = return intT
-- inferPrim Boolean {} = return boolT
-- inferPrim (Symbol name) = inferSymbol name
-- inferPrim (Bindings b) = TRows <$> traverse infer b
